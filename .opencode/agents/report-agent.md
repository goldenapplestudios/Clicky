...
<!--
  Generated by tools/generate-cli-targets.py from agents/report-agent.md.
  ...
  Scoped to these skills in Claude Code (skills: frontmatter): report-generation, session-management. OpenCode has no confirmed per-agent skill-allowlist mechanism -
