...
<!--
  Generated by tools/generate-cli-targets.py from agents/methodology-judge-agent.md.
  ...
  Scoped to these skills in Claude Code (skills: frontmatter): engagement-state, session-management, report-generation. OpenCode has no confirmed per-agent skill-allowlist mechanism -
