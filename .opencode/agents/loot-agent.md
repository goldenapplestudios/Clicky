...
<!--
  Generated by tools/generate-cli-targets.py from agents/loot-agent.md.
  ...
  Scoped to these skills in Claude Code (skills: frontmatter): credential-harvesting, data-exfiltration, report-generation, session-management, tool-management, evasion-techniques. OpenCode has no confirmed per-agent skill-allowlist mechanism -
