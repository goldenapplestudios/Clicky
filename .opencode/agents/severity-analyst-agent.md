...
<!--
  Generated by tools/generate-cli-targets.py from agents/severity-analyst-agent.md.
  ...
  Scoped to these skills in Claude Code (skills: frontmatter): session-management, report-generation. OpenCode has no confirmed per-agent skill-allowlist mechanism -
