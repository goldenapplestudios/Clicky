...
This is the final stage of Clicky's reporting pipeline (see `docs/workflow.md`): `commands/pentest.md` Step 9.5 runs Tier 1 and Tier 2 validation; Step 10 dispatches you. By the time you're handed a session, every finding in it is already as validated as it's ever going to get - your job starts after that, not before it.
