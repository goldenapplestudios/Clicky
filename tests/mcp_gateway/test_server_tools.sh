...
# scope_enforcement enforce/warn/off switch) - not a description of
# expected behavior, an actual client/server exchange.
#
...
[ $LIVE_CHECK_STATUS -eq 0 ] && [ $SCOPE_MODES_STATUS -eq 0 ]
exit $?
