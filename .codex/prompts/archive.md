<!-- Generated by tools/generate-cli-targets.py from commands/archive.md. Do not edit by hand. Install: .codex/install.sh copies this into $CODEX_HOME/prompts/ - Codex only discovers custom prompts there, confirmed never from a project-relative path (openai/codex#9848). -->
---
